...
// TODO INSPIRED BY NODE JS APPROACH MUCH CLOSER TO PHP ABOUT TRANSFORMER
class ObjectUtil
{
    // IMPORTED FROM NODEJS
    public const DEFAULT_CHANGE_CASE_OPTIONS =[
        "recursive"=>true,
        "arrayRecursive"=>true,
        ...
        "ignoreKeys"=>[],
        "ignorePaths"=>[],
        "defaultTransform"=>self::CasingConvention
    ];
    // IMPORTED FROM NODEJS
    public const CasingConvention =[
        "upper",
        "upperCase",
        "ucFirst",
        "upperCaseFirst",
    ...
    public static function transformObjectKeys(){
